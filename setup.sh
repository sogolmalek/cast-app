...
echo ""
echo "  2. For Solana / AUDD settlement, set in backend/.env:"
echo "     SOLANA_NETWORK=devnet              # or mainnet"
echo "     SOLANA_RPC_URL=https://api.devnet.solana.com"
echo "     SOLANA_AUDD_MINT=<AUDD mint address for your network>"
echo "     SOLANA_RECIPIENT_ADDRESS=<your Cast recipient wallet>"
echo "     SOLANA_SIGNER_SECRET=<base58 secret — server-side only>"
echo ""
