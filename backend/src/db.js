...
export function migrate() {
  ...
  // Migration: add ai_provider and ai_model columns to existing databases
  try {
    rawDb.run("ALTER TABLE users ADD COLUMN ai_provider TEXT DEFAULT 'anthropic'");
  } catch (e) {
    // Column already exists — ignore
  }
  try {
    rawDb.run("ALTER TABLE users ADD COLUMN ai_model TEXT");
  } catch (e) {
    // Column already exists — ignore
  }
}
